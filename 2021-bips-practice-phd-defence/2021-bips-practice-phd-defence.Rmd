...
Treat permutation feature importance (PFI) and partial dependence plots (PDP) as statistical estimators.
...
TODO: Draw image which shows link between model and DGP
...
TODO: simple image with DGP + model. External tools, PDP and PFI, applied externally and compared.
